        ...
        public override void Update()
        {
            ...
            if (Teammate != null)
            {
                if (Teammate.model.IsCulled)
                {
                    ...
                    UITexture.Position = new Vector2(400, 200);
                    UITexture.Size = new Vector2(200, 200);
                    ...
                    //Vector2 vectorToTeammate= teammatePos - myPos;

                    UITexture.Position = teammatePos;

                    UITexture.Position = Vector2.Clamp(UITexture.Position, new Vector2(padding, padding), new Vector2(Screen.Width - padding, Screen.Height - padding));
