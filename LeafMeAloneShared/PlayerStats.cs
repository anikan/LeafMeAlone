...
namespace Shared
{
    ...
    public class PlayerStats
    {
        ...
        public string ToString(PlayerStatsEnum type)
        {
           // string returnString = $"\nPlayer {playerId} Stats -----------------------\n";
            string returnString = "";
            switch (type)
            {
                case PlayerStatsEnum.LeafStats:
                    returnString += "\n-- Leaf Stats --\n";
                    ...
                    returnString += string.Format("Leaves Burned: {0}\n", numLeavesSetOnFire);
                    returnString += string.Format("Leaves Destroyed: {0}\n", numLeavesDestroyed);
                    //returnString += string.Format("Damage To Leaves: {0}\n", fireDamageDealtToLeaves);;
                    return returnString;

                case PlayerStatsEnum.PlayerStats:
                    returnString += "\n-- Player Stats --\n";
                    ...
                    return returnString;
                case PlayerStatsEnum.ShameStats:
                    returnString += "\n-- Shame Stats --\n";
